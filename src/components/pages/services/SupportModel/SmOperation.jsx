...
export default function SmOperation({ supportData }) {
  return (
      ...
      <div className="relative flex flex-col mb-2 p-5 lg:p-10 mx-5 lg:mx-10 mt-10">
        ...
        <div className="flex flex-col mt-10">
          ...
          <div className="w-[72%]">
            ...
            >
              {supportData?.smOperationData?.mainHeading}
            </p>
          </div>
          ...
          <div className="w-full lg:w-2/3 mb-5">
            <p className="mb-2 text-[#777777]" style={{ fontSize: "16px" }}>
              {supportData?.smOperationData?.descriptionText1}
            </p>
            <p className="text-[#777777] mt-5" style={{ fontSize: "16px" }}>
              {supportData?.smOperationData?.descriptionText2}
            </p>
          </div>
        </div>
